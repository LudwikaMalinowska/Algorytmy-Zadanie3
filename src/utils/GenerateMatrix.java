...
public class GenerateMatrix {
    ...
    public static <T extends Number> T[] createFinalVector(T classSample,Integer number){
        ...
        T[] resultVector =GenericVectorUtils.getZerosVector(classSample,listOfOptions.size());
        resultVector[listOfOptions.size()-1]=GenericNumberUtils.makeNumberOfClass(classSample,-1);
        return resultVector;
    }
